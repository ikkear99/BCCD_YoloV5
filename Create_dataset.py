...
image_Set = "BCCD/JPEGImages"
Annotations = "BCCD/Annotations" #.xml, .csv, .txt
data_Split = "BCCD/ImageSets/Main"
csv_path = "Meta_data/blood_cell_detection.csv"
...
if __name__ == '__main__':
    ...
    df = pd.read_csv("Meta_data/blood_cell_detection.csv")
